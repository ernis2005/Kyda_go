...
export const styles = StyleSheet.create({
    block:{
        overflow: 'hidden', marginLeft: 10,  height: 300, width: 200, marginTop: 10, borderRadius: 20 
    },
    block2:{
        overflow: 'hidden', marginLeft: 10,  height: 200, width: 300, marginTop: 10, borderRadius: 20 
    },
    text_1:{
